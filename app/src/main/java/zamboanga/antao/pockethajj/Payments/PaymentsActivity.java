...
public class PaymentsActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    PendingPaymentsFragment pendingPaymentsFragment = new PendingPaymentsFragment();
                    return pendingPaymentsFragment;
                case 1:
                    ApprovedPaymentsFragment approvedPaymentsFragment = new ApprovedPaymentsFragment();
                    return approvedPaymentsFragment;
            }
            return null;
        }
